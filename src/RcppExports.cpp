...
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(C_harmonicDist(data, subset, S_inv));
...
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(C_harmonicDist_partial(data, S_inv, i_start, i_end));
    return rcpp_result_gen;
END_RCPP
}
// C_kernelDeviance
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< std::vector< std::vector<double> > >::type S_inv(S_invSEXP);
    rcpp_result_gen = Rcpp::wrap(C_kernelDeviance(data, subset, sigma2, S_inv));
    return rcpp_result_gen;
END_RCPP
}
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< int >::type i_start(i_startSEXP);
    Rcpp::traits::input_parameter< int >::type i_end(i_endSEXP);
    rcpp_result_gen = Rcpp::wrap(C_kernelDeviance_partial(data, sigma2, S_inv, i_start, i_end));
    return rcpp_result_gen;
END_RCPP
}
// C_kernelDist
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< double >::type sigma2(sigma2SEXP);
    Rcpp::traits::input_parameter< std::vector< std::vector<double> > >::type S_inv(S_invSEXP);
    rcpp_result_gen = Rcpp::wrap(C_kernelDist(data, subset, sigma2, S_inv));
    return rcpp_result_gen;
END_RCPP
}
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< int >::type i_start(i_startSEXP);
    Rcpp::traits::input_parameter< int >::type i_end(i_endSEXP);
    rcpp_result_gen = Rcpp::wrap(C_kernelDist_partial(data, sigma2, S_inv, i_start, i_end));
    return rcpp_result_gen;
END_RCPP
}
// C_neighborDist
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< std::vector<int> >::type subset(subsetSEXP);
    Rcpp::traits::input_parameter< std::vector< std::vector<double> > >::type S_inv(S_invSEXP);
    rcpp_result_gen = Rcpp::wrap(C_neighborDist(data, subset, S_inv));
    return rcpp_result_gen;
END_RCPP
}
