...
#' @keywords internal
# ---------------------------------------------------------------------------------------------------------------
ui <- shinydashboard::dashboardPage(title= "MINOTAUR",
                                    ...
                                    shinydashboard::dashboardSidebar(
                                      shinydashboard::sidebarMenu(
                                        ...
                                        # Data menu
                                        shinydashboard::menuItem("Data", tabName="data", icon=icon("bars"),
                                        ...
                                        shinydashboard::menuItem("Multivariate Measures", tabName="multivariate", icon=icon("calculator"),
                                        ...
                                        # Produce Plots menu
                                        shinydashboard::menuItem("Produce Plots", tabName="plots", icon=icon("area-chart"),
                                    ...
                                    shinydashboard:: dashboardBody(
                                      ...
                                      shinydashboard::tabItems(
                                        ...
                                        #### Format Data page
                                        shinydashboard::tabItem(tabName="data_format",
                                                fluidRow(
                                                  column(4,
                                                         # Format Data box
                                        ...
                                        #### Calculate page
                                        shinydashboard::tabItem(tabName="calc_multi",
                                                fluidRow(
                                                  column(7,
                                        ...
                                        shinydashboard::tabItem(tabName="plots_histogram_1D",
                                                fluidRow(
                                                  column(12,
                                        ...
                                        #### Scatter Plot page
                                        shinydashboard::tabItem(tabName="plots_2D_scatterplot",
                                                fluidRow(
                                                  column(12,
                                        ...
                                        shinydashboard::tabItem(tabName="plots_linear_Manhattan",
                                                fluidRow(
                                                  column(12,
                                        ...
                                        #                         shinydashboard::tabItem(tabName="plots_circular_Manhattan",
                                        #                                 fluidRow(
                                        #                                   column(12,
