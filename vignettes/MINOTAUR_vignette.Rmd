...
![Welcome Page](1_WelcomePage.jpg)
...
![MINOTAUR Overall Menu](2_Menu.jpg)
...
![Load Data Menu](3_LoadDataMenu.jpg)
...
![Input Data Summary](4_DataSummary.jpg)
...
![Identifying Location Variables](5_IdentifyPositions.jpg)
...
![Data Filtering Options](6_FilterDataOptions.jpg)
...
![Filtered Data Summary](7_FilterDataSummaries.jpg)
...
![Distance-Based Methods Options](8_DistanceOptions.jpg)
...
![Density-Based Methods Options](9_DensityOptions.jpg)
...
![Multivariate Measures Table](10_MultivariateTable.jpg)
...
Each plotting submenu contains two options menus and the resulting plot. The 'Select Variables' menu is used to manipulate what data are being plotted on each axis, plus intuitive, general attributes about the axes themselves. Under 'Select y-axis' we will select the output of our Nearest Neighbord Distance calculation (called 'Nd') to display a Manhattan plot of this distance across all loci in the dataset.

![Axes Variable Options](11_AxisOptions.jpg)
...
![Outlier Highlighting Options](12_OutlierOptions.jpg)
...
![Plot Aesthetics Menu](13_AesthOptions.jpg)

And here is the resulting plot based on these options.

![Resulting Manhattan Plot](14_NdPlot.jpg)
...
![Stacked Manhattan Plots](15_StackedPlots.jpg)
